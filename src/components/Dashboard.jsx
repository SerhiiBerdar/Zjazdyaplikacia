      ...
      <div className="card fade-in-up" style={{ padding: 22, marginBottom: 20 }}>
        ...
        {inputTab === 'manual' && (
          <>
            ...
            {parseStatus.msg && inputTab === 'manual' && (
            ...
            {allData.length > 0 && (
              <div style={{ marginTop: 14, paddingTop: 14, borderTop: '1px solid var(--border)', display: 'flex', gap: 10, alignItems: 'center' }}>
                <span style={{ fontSize: 12, color: 'var(--text2)' }}>Celkovo v pamäti: <strong style={{ color: 'var(--accent)' }}>{allData.length.toLocaleString('sk')}</strong> záznamov</span>
